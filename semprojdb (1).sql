...
--
-- Table structure for table `unitcategory`
--
...
--
-- Dumping data for table `unitcategory`
--

INSERT INTO `unitcategory` (`UnitID`, `UnitType`, `Description`) VALUES
(13, 'Studio', 'Bedroom: 1\nBathroom: 1\n'),
(16, 'Family', 'Bedroom: 2\nBathroom: 2\nKitchen: 1\nBalcony'),
(17, 'Bed Spacer', 'Bedroom:1\nBed (Double Deck): 8\nBathroom: 2\nKitchen:1\nBalcony');
...
--
-- Indexes for table `unitcategory`
--
...
--
-- AUTO_INCREMENT for table `unitcategory`
--
ALTER TABLE `unitcategory`
  MODIFY `UnitID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
